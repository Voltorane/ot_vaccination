...
def choose_place(schedule_list, p=False):
    ...
    while True:
        ...
        if not blacklisted:
            ...
            schedule_list = get_schedule_list(p)
...
def main():
    if '-pfizer' in sys.argv:
        choose_place(get_schedule_list(p=True), p=True)
    else:
